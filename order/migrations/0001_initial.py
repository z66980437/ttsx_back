# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-03 05:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('PAYING', '待支付'), ('TRADE_SUCCESS', '成功'), ('TRADE_FINISHED', '交易结束'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_CLOSE', '交易关闭')], default='PAYING', max_length=20, verbose_name='交易状态')),
